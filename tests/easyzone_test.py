...
class ZoneLoadTest(unittest.TestCase):
    ...
    def test_root_records_AAAA(self):
        ...
        self.assertEqual(records, ['aaaa:bbbb:cccc::1'])
    ...
    def test_root_records_MX(self):
        ...
        self.assertEqual(records, [(10, 'mail.example.com.'), (20, 'mail2.example.com.')])

    def test_names_type(self):
        names = self.zone.names
        self.assertEqual(type(names), dict)
    ...
    def test_names_xmpp_SRV(self):
        ...
        self.assertEqual(records, [(20, 0, 5222, 'foobar.example.com.')])
...
class ZoneModifyTest(unittest.TestCase):
    ...
    def test_root_add_NS(self):
        ...
        records = self.zone.names['example.com.'].records('NS').items
        self.assertEqual(records, ['ns1.example.com.', 'ns2.example.com.', 'ns3.example.com.'])
    ...
    def test_root_delete_noexist_NS(self):
        ...
        self.assertRaises(RecordsError, self.zone.root.records('NS').delete, 'ns99.example.com.')
    ...
    def test_root_add_AAAA(self):
        ...
        self.assertEqual(records, ['aaaa:bbbb:cccc::1', 'aaaa:bbbb:cccc::2'])
    ...
    def test_names_add_root_MX(self):
        ...
        records = self.zone.names['example.com.'].records('MX').items
        self.assertEqual(records, [(10, 'mail.example.com.'), (20, 'mail2.example.com.'), (30, 'mail3.example.com.')])
    ...
    def test_names_add_bar_AAAA(self):
        ...
        self.assertEqual(records, ['aaaa:bbbb:cccc::2', 'aaaa:bbbb:cccc::3', 'aaaa:bbbb:cccc::123'])
    ...
    def test_names_delete_bar_AAAA(self):
        ...
        records = self.zone.names['bar.example.com.'].records('AAAA').items
        self.assertEqual(records, ['aaaa:bbbb:cccc::2'])
    ...
    def test_names_add_xmppserver_SRV(self):
        ...
        self.assertEqual(records, [(20, 0, 5269, 'bar.example.com.')])
    ...
    def test_delete_name_foo(self):
        ...
        self.assertEqual(sorted(list(self.zone.names.keys())), sorted(['foofoo.example.com.', '_xmpp-client._tcp.example.com.', 'bar.example.com.', 'example.com.']))
    ...
    def test_names_bar_clear_all_records(self):
        ...
        self.assertEqual(sorted(list(self.zone.names.keys())), sorted(['foo.example.com.', 'foofoo.example.com.', '_xmpp-client._tcp.example.com.', 'bar.example.com.', 'example.com.']))
        self.assertEqual(self.zone.names['bar.example.com.'].records('A'), None)
    ...
    def test_names_foo_clear_all_records_exclude(self):
        ...
        self.assertEqual(sorted(list(self.zone.names.keys())), sorted(['foo.example.com.', 'foofoo.example.com.', '_xmpp-client._tcp.example.com.', 'bar.example.com.', 'example.com.']))
        self.assertEqual(self.zone.names['foo.example.com.'].records('A'), None)
        self.assertEqual(self.zone.names['foo.example.com.'].records('MX').items, [(10, 'mail.example.com.')])
    ...
    def test_names_foo_clear_all_records_include(self):
        ...
        self.assertEqual(sorted(list(self.zone.names.keys())), sorted(['foo.example.com.', 'foofoo.example.com.', '_xmpp-client._tcp.example.com.', 'bar.example.com.', 'example.com.']))
        self.assertEqual(self.zone.names['bar.example.com.'].records('AAAA'), None)
        self.assertEqual(self.zone.names['bar.example.com.'].records('A').items,['10.0.0.2', '10.0.0.3'])
    ...
    def test_names_add_bar_TXT_with_periods(self):
        ...
        records = self.zone.names['bar.example.com.'].records('TXT').items
        self.assertEqual(records, ['"v=spf1 a mx include:mailseat.com include:cluster3.eu.messagelabs.com ?all"'])
